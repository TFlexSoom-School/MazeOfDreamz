...
#This one happens to be the first player controller. Each ClientControl file
...
Csocket.send("red")              #This change sthe LED light on the controller to be blue on the controller
